...
// prettier-ignore
function Tapbody(mode,startPosition,loop) {
...
Tapbody.prototype = new createjs.MovieClip()
Tapbody.prototype.nominalBounds = new createjs.Rectangle(0, 0, 388.3, 360.2)

// prettier-ignore
function Tap(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
Tap.prototype = new createjs.MovieClip()
Tap.prototype.nominalBounds = new createjs.Rectangle(0, 0, 26.9, 132.2)

// prettier-ignore
function Header(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(createjs.Tween.get({}).to({state:[{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}
Header.prototype = new createjs.MovieClip()
Header.prototype.nominalBounds = new createjs.Rectangle(0, 0, 201.3, 54)

// stage content:
// prettier-ignore
function Construction(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Каркас_1
	this.ikNode_2 = new Header();
	this.ikNode_2.setTransform(147.6,176.7,0.999,0.999,0,0,0,100.9,27.2);

	this.ikNode_1 = new Tap();
	...
	// tap-body.svg
	this.instance = new Tapbody();
	this.instance.setTransform(242.3,186.3,1,1,0,0,0,194.1,180.1);

	this.timeline.addTween(createjs.Tween.get(this.instance).wait(100));

}
Construction.prototype = new createjs.MovieClip()
Construction.prototype.nominalBounds = new createjs.Rectangle(
  276.7,
  196.2,
  389.8,
  360.2
